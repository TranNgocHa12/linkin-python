...
def enter_ids_on_lk_signin(driver, email, password):
	...
	# passwordInputElement.send_keys(password)
	usernameInputElement = driver.find_elements(By.ID, "_R_1h6kqsqppb6amH1_")[0]
	usernameInputElement.send_keys(email)
	passwordInputElement = driver.find_elements(By.ID, "_R_1hmkqsqppb6amH1_")[0]
	passwordInputElement.send_keys(password)
	submitElement = driver.find_elements(By.CLASS_NAME,"x3nfvp2")[2]
