...
if __name__ == "__main__":
    ...
    # home_url = "https://www.linkedin.com/jobs/search-results/?currentJobId=4384208616&keywords=.NET%20developer&origin=JOB_SEARCH_PAGE_LOCATION_AUTOCOMPLETE&geoId=106808692"
    ...
    for job_name in jobs_names:   
        ...
        for geoID in geoIDs:
            ...
            #             titleInputElement = driver.find_element(By.CSS_SELECTOR,'[id*="«r23»"]')
            #             time.sleep(2)
            ...
            #             locationButton = driver.find_element(By.CLASS_NAME, "f9698124")    #1st element of div below div with role button
            #             locationButtonElement = locationButton.find_element(By.XPATH, "..")
            #             locationButtonElement.click()
            #             time.sleep(10)
            #             locationInputElement = driver.find_element(By.CLASS_NAME,"_9dec327d")                        
            ...
            time.sleep(5)
            try:
                past_week = driver.find_element(By.CSS_SELECTOR, '[aria-label="Past week"]')
                past_week.click()
                time.sleep(5)
            except:
                print("error")
            ...
            for job in jobs:
                ...
                lead_id = ""
                try:
                    job_ele_1 = job.find_element(By.CSS_SELECTOR, "[role='button']")
                    job_title = job_ele_1.find_elements(By.TAG_NAME, "p")[0].text
                    print(job_title)
